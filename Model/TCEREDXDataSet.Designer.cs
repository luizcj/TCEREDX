...
namespace Model {
    ...
    public partial class TCEREDXDataSet : global::System.Data.DataSet {
        ...
        public partial class SequencialGedDataTable : global::System.Data.TypedTableBase<SequencialGedRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public SequencialGedRow FindByNumeroDVAno(int Numero, int DV, int Ano) {
        ...
        public partial class SequencialGedRow : global::System.Data.DataRow {
            ...
            public int Sequencial {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("O valor da coluna \'Sequencial\' na tabela \'SequencialGed\' é DBNull.", e);
                    }
                }
                set {
            ...
            public bool IsSequencialNull() {
                return this.IsNull(this.tableSequencialGed.SequencialColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public void SetSequencialNull() {
                this[this.tableSequencialGed.SequencialColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Model.TCEREDXDataSetTableAdapters {
    ...
    public partial class SequencialGedTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[SequencialGed] WHERE (([Numero] = @Original_Numero) AND ([DV] = @Original_DV) AND ([Ano] = @Original_Ano) AND ((@IsNull_NomeArquivo = 1 AND [NomeArquivo] IS NULL) OR ([NomeArquivo] = @Original_NomeArquivo)) AND ((@IsNull_Sequencial = 1 AND [Sequencial] IS NULL) OR ([Sequencial] = @Original_Sequencial)))";
...
SELECT Numero, DV, Ano, NomeArquivo, Sequencial FROM SequencialGed WHERE (Ano = @Ano) AND (DV = @DV) AND (Numero = @Numero)";
...
SELECT Numero, DV, Ano, NomeArquivo, Sequencial FROM SequencialGed WHERE (Ano = @Ano) AND (DV = @DV) AND (Numero = @Numero)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Model.Properties.Settings.Default.TCEREDXConnectionString;
        }
        ...
        public virtual int Fill(TCEREDXDataSet.SequencialGedDataTable dataTable) {
        ...
        public virtual TCEREDXDataSet.SequencialGedDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            TCEREDXDataSet.SequencialGedDataTable dataTable = new TCEREDXDataSet.SequencialGedDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(TCEREDXDataSet.SequencialGedDataTable dataTable) {
